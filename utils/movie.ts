...
const movie: Omit<Movie, "rank">[] = [
...

  {
    ...
    hot: "false",
    description:
      "13/7/2568 สัตว์สยอง กยองซอง ภาคเเรก ด้านเนื้อเรื่อง น่าสนใจนะ ทำให้อยากดูต่อโอเคเลย เเต่ที่ surprise เลยคือฉากจิ้นที่เเบบ เยอะกว่าที่คิดมาก เคมีเข้ากันมากๆ เเละมีเหตุผลมาก เเต่ข้อเสียที่ทำให้เศร้าไม่สุดคือปูมหัลงปูน้อยไปหน่อย ทำให้มันไม่ค่อยอิน เเต่มันน่าติดตามในช่วงท้ายๆ เเล้วเเบบผิดคาดมาก นึกว่านางเอกตายจริง ตัวร้ายก็ไม่ได้ร้ายปัญญาอ่อน มันเลวเเบบโง่ๆ ก็เลยไม่ขัดใจไรมาก โดยรวมสนุกใช้ได้ เเต่ยังไม่ถึงขั้น God",
    category: "Series",
    genre: "Action",
